...
import model.login;
public class HelloController extends LoginController{
    ...
    void facultyClick(MouseEvent event) throws IOException {
        AnchorPane view = FXMLLoader.load(getClass().getResource("teachersContact.fxml"));
        borderpane.setCenter(view);
    ...
    void noticeClick(MouseEvent event) throws IOException {
        AnchorPane view = FXMLLoader.load(getClass().getResource("Notice.fxml"));
        borderpane.setCenter(view);
    }
